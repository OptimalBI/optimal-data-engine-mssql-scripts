...
BEGIN
	INSERT @Hub_Link
	SELECT h.hub_key, h.hub_name, l.link_key, l.link_name FROM [dbo].[dv_hub] h
...
SELECT h' + @proc_hub_name + '.[' + @proc_hub_column + ']'
	ELSE
...
FOR 
SELECT c1.satellite_key, c3.satellite_name, c2.column_name 
