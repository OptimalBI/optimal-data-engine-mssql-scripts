...
SELECT @func_suffix_all = CAST([ODE_Config].[dbo].[fn_get_default_value] ('Suffix_all', 'ODE_AccessFunction') as VARCHAR)
	...
	SELECT @sat_select += 
		replace(
			replace(
				replace(
					replace(
						    [ODE_Config].[dbo].[fn_get_satellite_cdc_all_statement] ('1900-01-01 00:00:00.0000000 +12:00', '9999-01-01 00:00:00.0000000 +12:00')
					...
					, '')
				,'[dv_'
				, QUOTENAME([ODE_Config].[dbo].[fn_get_object_name](@satellite_name, 'sat'))+'.[dv_') + @crlf 
